...
#                self.database.setRequestForClose(True)
...
#            self.database = src.Database()
    ...
    def playChannel(self, channel):
        ...
        control = self._findControlAt(self.focusPoint)
        #xbmc.log(msg='Raven startlog 1:'+str(control), level=xbmc.LOGNOTICE)
    ...
    def onRedrawEPG(self, channelStart, startTime, focusFunction=None):
        ...
        xbmc.log(msg='METH: _onRedrawEPG - beginning -> [counter]:'+str(self.testcounter), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG - beginning -> [channelstart]:'+str(channelStart), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG - beginning -> [isplaybackstopped]:'+str(self.isPlaybackStopped), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG - beginning -> [mode]:'+str(self.mode), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG - beginning -> [redrawingEPG]:'+str(self.redrawingEPG), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG - beginning -> [isClosing]:'+str(self.isClosing), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG - beginning -> [databaseupdate]:'+str(self.database.updateInProgress), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG - beginning -> [chanelidx]:'+str(self.channelIdx), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG - beginning -> [player.isPlaying]:'+str(self.player.isPlaying()), level=xbmc.LOGDEBUG)
        ...
        #if self.isPlaybackStopped and self.mode==MODE_EPG:
        #    return 
        #if self.player.isPlaying() and self.mode==MODE_EPG:
        #    return 
        
            

        xbmc.log(msg='METH: _onRedrawEPG 1 -> [counter]:'+str(self.testcounter), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG 1 -> [channelstart]:'+str(channelStart), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG 1 -> [isplaybackstopped]:'+str(self.isPlaybackStopped), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG 1 -> [mode]:'+str(self.mode), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG 1 -> [chanelidx]:'+str(self.channelIdx), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG 1 -> [player.isPlaying]:'+str(self.player.isPlaying()), level=xbmc.LOGDEBUG)
        ...
        self._clearEpg()
        xbmc.log(msg='METH: _onRedrawEPG 2:'+str(self.testcounter), level=xbmc.LOGDEBUG)
        try:
            xbmc.log(msg='METH: _onRedrawEPG 2.1:'+str(self.testcounter), level=xbmc.LOGDEBUG)
            #time.sleep(0.6)
            ...
            xbmc.log(msg='METH: _onRedrawEPG 2.2:'+str(self.testcounter), level=xbmc.LOGDEBUG)
        except src.SourceException, Exception:
            #xbmc.log(msg='METH: _onRedrawEPG 2.3:', level=xbmc.LOGDEBUG)        
            self.onEPGLoadError()
            return
        except:            
            #xbmc.log(msg='METH: _onRedrawEPG 2.4:', level=xbmc.LOGDEBUG) 
            print "Unexpected error:", sys.exc_info()[0]
            
        xbmc.log(msg='METH: _onRedrawEPG 3:'+str(self.testcounter), level=xbmc.LOGDEBUG)
        channelsWithoutPrograms = list(channels)
        xbmc.log(msg='METH: _onRedrawEPG 4:'+str(self.testcounter), level=xbmc.LOGDEBUG) 
        # date and time row
        ...
        for col in range(1, 5):
            ...
            startTime += HALF_HOUR
        xbmc.log(msg='METH: _onRedrawEPG 5:'+str(self.testcounter), level=xbmc.LOGDEBUG) 
        if programs is None:
            xbmc.log(msg='METH: _onRedrawEPG 6:'+str(self.testcounter), level=xbmc.LOGDEBUG)  
            self.onEPGLoadError()
            return
        xbmc.log(msg='METH: _onRedrawEPG 7:'+str(self.testcounter)+' : '+str(self.channelIdx), level=xbmc.LOGDEBUG)
        ...
        xbmc.log(msg='METH: _onRedrawEPG 8 [focusfunc]:'+str(focusFunction), level=xbmc.LOGDEBUG)
        ...
        xbmc.log(msg='METH: _onRedrawEPG 9 [focuscontrol] :'+str(focusControl), level=xbmc.LOGDEBUG)
        ...
        xbmc.log(msg='METH: _onRedrawEPG 10 [controlAndProgramList] :'+str(len(self.controlAndProgramList)), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG 10 [mode] :'+str(self.mode), level=xbmc.LOGDEBUG)
        xbmc.log(msg='METH: _onRedrawEPG 10 [counter]:'+str(self.testcounter), level=xbmc.LOGDEBUG)
    ...
    def onPlayBackStopped(self):
        xbmc.log(msg='METH: _onPlayBackStopped ', level=xbmc.LOGDEBUG)
        if not self.player.isPlaying() and not self.isClosing:
            self.isPlaybackStopped=True
            self._hideControl(self.C_MAIN_OSD)
            # von mir
            #self.isClosing=True
